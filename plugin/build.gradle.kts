...
//    compileOnly("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.2")
    ...
    compileOnly("net.Indyuce:MMOItems-API:${rootProject.property("mmoItemsVersion")}") { isTransitive = false }
    ...
    compileOnly("io.lumine:MythicLib-dist:${rootProject.property("mythicLibVersion")}") { isTransitive = false }
...
val mmoItemsVersion: String by rootProject
val mythicLibVersion: String by rootProject
